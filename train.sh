...
python main.py --phase train --dataset_name oil-chinese --lambda_A 500.0 --lambda_B 500.0 --epoch 100  #

python main.py --phase train --dataset_name facades --lambda_A 1000.0 --lambda_B 1000.0  --epoch 100 #

python main.py --phase train --dataset_name sketch-photo --lambda_A 1000.0 --lambda_B 1000.0 --epoch 100 #
